...
if ( ! function_exists( 'magnetic_wp_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function magnetic_wp_posted_on() {
      ...
      $time_string,
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'magnetic-wp' ),
...
if ( ! function_exists( 'magnetic_wp_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function magnetic_wp_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'magnetic-wp' ),
...
if ( ! function_exists( 'magnetic_wp_comments_link' ) ) :
	/**
	 * Prints HTML with a link to the comments for a post.
	 */
	function magnetic_wp_comments_link() {
      ...
      comments_popup_link(
        sprintf(
          ...
          /* translators: %s: post title */
            __( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'magnetic-wp' ),
            array(
              'span' => array(
                'class' => array(),
              ),
...
if ( ! function_exists( 'magnetic_wp_print_categories' ) ) :
	/**
   ...
   * Set $list_label parameter to true to output the text label pre-pended to the list.
	 */
  function magnetic_wp_print_categories($list_label = false) {
...
if ( ! function_exists( 'magnetic_wp_print_tags' ) ) :
	/**
   ...
   *
	 ...
	 * Set $list_label parameter to true to output the text label pre-pended to the list.
	 */
	function magnetic_wp_print_tags($list_label = false) {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space */
...
if ( ! function_exists( 'magnetic_wp_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories and tags, and post edit link.
	 */
	function magnetic_wp_entry_footer() {
    magnetic_wp_print_categories(true);
    magnetic_wp_print_tags(true);

		edit_post_link(
			sprintf(
				wp_kses(
					/* translators: %s: Name of current post. Only visible to screen readers */
					__( 'Edit <span class="screen-reader-text">%s</span>', 'magnetic-wp' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'magnetic_wp_post_thumbnail' ) ) :
/**
 ...
 */
function magnetic_wp_post_thumbnail($img_size = 'post-thumbnail') {
