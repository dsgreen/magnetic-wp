...
<div class="wp-block-cover alignfull" style="margin-top:0;margin-bottom:0;padding-top:8em;padding-right:2em;padding-bottom:2em;padding-left:2em;min-height:75vh"><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":1,"align":"wide","style":{"typography":{"fontSize":"5rem","fontWeight":"300"}},"textColor":"white"} -->
<h1 class="wp-block-heading alignwide has-white-color has-text-color" style="font-size:5rem;font-weight:300">Your Page Title</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"wide","style":{"typography":{"fontSize":"2.2rem"}},"textColor":"white"} -->
<p class="has-white-color has-text-color alignwide" style="font-size:2.2rem">Add a subtitle or lead text here.</p>
